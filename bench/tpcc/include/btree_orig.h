...
private:
	  ...
	  //                unsigned char _pad[LEAF_NODE_PADDING];
        ...
        struct AlignedMemoryAllocator {
                ...
                {
                        return S_MALLOC(bytes); // TODO: returns not alligned memory
                        // void* result;
        ...
        __attribute__((transaction_safe)) inline LeafNode* new_leaf_node() {
                LeafNode* result = (LeafNode*) S_MALLOC(sizeof(LeafNode));
                initLeafNode(result);
        ...
        __attribute__((transaction_safe)) inline InnerNode* new_inner_node() {
                InnerNode* result = (InnerNode*) S_MALLOC(sizeof(InnerNode));
